...
//                 {/* <!-- Left Content --> */}
//                 <div className="lg:w-1/2 w-full lg:mb-0 space-y-5 order-2">
//                     <h1 className="text-large lg:text-5xl font-bold text-primary leading-tight md:leading-snug lg:leading-[55px]">
...
//                     </h1>
//                     <p className="text-gray-700 font-medium text-small max-w-[500px]">Say goodbye to WordPress headaches! Our low-cost
//                         expert services keep your site secure, fast, and updated so
//                         that you can focus on business growth with peace of mind.
//                     </p>
//                     <Link to="/services" className="bg-light-blue border border-light-blue text-white lg:px-10 lg:py-5 p-3.5 rounded-lg inline-block font-medium hover:bg-[#103498] transition-all duration-300 ease-in">Get Expert Care Now</Link>
//                 </div>

//                 {/* <!-- Right Image Container --> */}
//                 <div className="lg:w-1/2 flex flex-col order-1">

        ...
        <section className="about-stroy md:pt-10 pt-5">
            <div className="container mx-auto flex flex-col md:flex-row gap-6 p-8">
                ...
                <div className="flex-1 md:py-5">
                    ...
                    <p className="text-primary font-medium text-medium md:text-base leading-normal ">
                    ...
                    <p className="text-primary font-medium text-medium md:text-base mt-4 leading-normal">

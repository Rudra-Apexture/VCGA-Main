...
const Grow = () => {
  return (
    <section className='grow-ready md:pt-10 pt-5'>
        ...
        <div className="bg-light-blue rounded-medium flex lg:flex-row flex-col justify-between">
          <div className="lg:w-1/2 w-full">
            <div className="lg:p-20 p-6 text-white lg:text-left text-center ">
              ...
              <div className='mb-4'>
                <Link to="/contact-us" className="bg-white text-light-blue font-medium text-medium p-4 md:px-10 w-full mb-6 rounded-md">Get Started Today</Link>
              </div>
            </div>
          </div>

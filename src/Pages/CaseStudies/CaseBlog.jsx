                        ...
                        {cases.map((caseItem) => (
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <div
                                        className="absolute bottom-0 left-0 w-full p-4 bg-black/70 text-white opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-10 transition-all duration-500 ease-in-out"
                                    >

            ...
            {!loading && !error && blog && (
                <div className="bg-light-blue lg:py-14 py-16 text-white">
                    <div className="max-w-7xl mx-auto md:space-y-5 space-y-4 px-4">
                        <h2 className="lg:text-small text-xs font-normal text-center flex justify-center items-center gap-2">
                        ...
                        <div className='flex justify-center'>
                            <p className="md:text-5xl text-small font-bold capitalize max-w-5xl text-center" >
                                {blog.title}
                            </p>
                        </div>

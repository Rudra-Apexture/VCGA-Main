...
const Satisfaction = () => {
    ...
    return (
        <section className="Satisfaction-Card md:pt-10 pt-5">
            <div className="container mx-auto">
                ...
                <div className="lg:p-10 p-6 my-10 rounded-medium relative bg-gray-100">
                    <button
                        onClick={handlePrev}
                        className="absolute lg:-left-5 left-2.5 top-1/2 transform -translate-y-1/2 z-20 lg:p-3 p-1.5 bg-light-blue rounded-full focus:outline-none"
                    >
                    ...
                    <button
                        onClick={handleNext}
                        className="absolute lg:-right-5 right-2.5 top-1/2 transform -translate-y-1/2 z-20 lg:p-3 p-1.5 bg-light-blue rounded-full focus:outline-none"
                    >
                    ...
                    >
                        {testimonials.map((testimonial, index) => (
                            <SwiperSlide key={index} className="swiper-slide-custom">
                                <div className="bg-white border border-slate-300 rounded-medium md:p-6 p-4 flex flex-col space-y-5 w-full transition-transform duration-300 hover:scale-102">
                                    <div className="flex items-center md:justify-between justify-center">

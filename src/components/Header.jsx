...
const Header = () => {
    ...
    return (
        <>
            ...
            <header className={`top-0 z-30 relative transition-shadow duration-300 py-2
                        ...
                        {[
                            ...
                            <div key={index} className="relative group">
                                <Link
                                    ...
                                    ${isActive(item.path) ? 'text-[#1a57ff] font-semibold' : ''}`}
                                >
                                    {item.label}
                        ...
                        {[
                            ...
                            <Link
                                ...
                                className={`text-primary font-normal text-medium hover:text-blues transition-colors duration-200 mb-4 
                                    ${isActive(item.path) ? 'text-[#146aff] font-semibold' : ''}`}
                                onClick={toggleMenu}
                            >
                                {item.label}
                            </Link>
